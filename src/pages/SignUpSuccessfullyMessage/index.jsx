...
const SignUpSuccessfullyMessage = () => {
    ...
    <>
      <div className="flex md:flex-col justify-center items-center w-full">
        <div className="w-[100%] md:w-full">
          ...
          <div className="w-full h-[100vh] sm:px-4 flex flex-col justify-center items-center">
            <div className="max-w-[475px] text-center">
              <Img src="images/img_success_alert.svg" className="m-auto" />
              ...
              <Text className="text-[14px] font-normal mb-[36px]">
                {t(
                  "common.weHaveSentAVerificationLinkOnEmailAddressPleaseClickTheLinkInEmailToActivateYourAccount"
                )}
              </Text>
              <Button
...
export default SignUpSuccessfullyMessage;
